...
const EditCustomerAddressDrawer = props => {
  // ** Props
      ...
      <Box sx={{ p: 5 }}>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <FormControl fullWidth sx={{ mb: 6 }}>
            <InputLabel id='businessType-label'>Select Business Type</InputLabel>
            <Controller
              name='businessType'
              control={control}
              rules={{ required: true }}
            ...
            />
            {errors.businessType && <FormHelperText sx={{ color: 'error.main' }}>{errors.businessType.message}</FormHelperText>}
          </FormControl>
...
export default EditCustomerAddressDrawer
