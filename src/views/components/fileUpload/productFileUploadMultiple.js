...
import productImageBlock from 'src/data/productImageBlock'
...
const ProductFileUploadMultiple = () => {
  // ** State
...
export default ProductFileUploadMultiple
