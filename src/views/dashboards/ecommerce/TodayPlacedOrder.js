...
const TodayPlacedOrder = () => {
  return (
    <Card>
      <DataGrid rowHeight={75} hideFooter rows={rows} columns={columns} disableSelectionOnClick pagination={undefined} />
    </Card>
  )
}

export default TodayPlacedOrder
