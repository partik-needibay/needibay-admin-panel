...
const EcommerceTotalCustomer = () => {
  return (
    <Card>
      <CardContent>
        <Box sx={{ mb: 6.5, display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
          <Box>
            <Typography variant='body2'>Total Customer</Typography>
            <Typography variant='h6'>22.5k</Typography>
          </Box>
...
export default EcommerceTotalCustomer
