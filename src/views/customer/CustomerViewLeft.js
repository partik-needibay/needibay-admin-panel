...
import { fetchCustomerDataByCustomerId, fetchCustomerOrderByCustomerId } from 'src/store/apps/customer'
...
const CustomerViewLeft = ({ id }) => {
  ...
  const data = useSelector(store => store.customer?.customerData)
              ...
              <Box sx={{ mr: 8, display: 'flex', alignItems: 'center' }}>
                ...
                <div>
                  <Typography variant='h6' sx={{ lineHeight: 1.3 }}>
                    {customerOrder?.data?.totalElements}
                  </Typography>
          ...
          <CardContent>
            ...
            <Box sx={{ pt: 2, pb: 1 }}>
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                ...
                <Typography variant='body2'>{data?.data?.phoneBooks?.length > 0 && data?.data?.phoneBooks[0].phone}</Typography>
              </Box>
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                  Primary Email:
                </Typography>
                <Typography variant='body2'>{data?.data?.emailBooks?.length > 0 && data?.data?.emailBooks[0].email}</Typography>
              </Box>
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                  Business Type:
                </Typography>
                <Typography variant='body2'>{data?.data?.businessType}</Typography>
              </Box>
              ...
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                ...
                <Typography variant='body2'>{data?.data?.position}</Typography>
              </Box>
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
