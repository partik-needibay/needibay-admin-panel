        ...
        <Grid item xs={12}>
          <Card>
            <CardContent sx={{ pt: 15, display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
              ...
              >
                {data.name ? getInitials(data.name) : data.name}
              </CustomAvatar>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <div>
                    ...
                    <Typography variant='body2'>Upcoming Event</Typography>
                  </div>
                </Box>
              </Box>
              <Divider style={{ marginTop: '1.2rem', marginBottom: '1.2rem' }}></Divider>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Box sx={{ mr: 8, display: 'flex', alignItems: 'center' }}>
                  <CustomAvatar skin='light' variant='rounded' sx={{ mr: 3 }}>
                    <Icon icon='mdi:check' />
                ...
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <div>
                    ...
                    <Typography variant='body2'>Paid Payment</Typography>
                  </div>
                </Box>
              </Box>
            </CardContent>
            ...
            <CardContent>
              <Typography variant='h6'>Primary Contact Person</Typography>
              ...
              {data.contact && data.contact.length > 0 && (
                <Box sx={{ pt: 2, pb: 1 }}>
                  <Box sx={{ display: 'flex', mb: 2.7 }}>
                    ...
                    <Typography variant='body2'>{`${data.contact[0].firstName} ${data.contact[0].lastName}`}</Typography>
                  </Box>
                  <Box sx={{ display: 'flex', mb: 2.7 }}>
                    <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                      Email:
                    </Typography>
                    <Typography variant='body2'>{`${data.contact[0].email}`}</Typography>
                  </Box>
                  <Box sx={{ display: 'flex', mb: 2.7 }}>
                    <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                      Phone:
                    </Typography>
                    <Typography variant='body2'>{`${data.contact[0].phone}`}</Typography>
                  </Box>
                  <Box sx={{ display: 'flex', mb: 2.7 }}>
                    <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                      Is Owner:
                    </Typography>
                    <Typography variant='body2'>{`${data.contact[0].isOwner ? 'Yes' : 'No'}`}</Typography>
                  </Box>
                </Box>
              )}
            </CardContent>
