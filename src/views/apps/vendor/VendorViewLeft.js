...
import { fetchCustomerDataByCustomerId } from 'src/store/apps/customer'
          ...
          <CardContent>
            ...
            <Box sx={{ pt: 2, pb: 1 }}>
              ...
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                ...
                <Typography variant='body2'>{gstTreatment.find(o => o.value == data?.data?.gstTreatment)?.label}</Typography>
              </Box>
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                  GST Registration:
                </Typography>
                <Typography variant='body2'>{data?.data?.gstReg}</Typography>
              </Box>
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                  Payment Terms:
                </Typography>
                <Typography variant='body2'>{data?.data?.paymentTerms}</Typography>
              </Box>
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                  PAN:
                </Typography>
                <Typography variant='body2'>{data?.data?.pan}</Typography>
              </Box>
              ...
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                ...
                <Typography variant='body2'>{data?.data?.website}</Typography>
              </Box>
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                    Created On:
                </Typography>
                <Typography variant='body2'>{data?.data?.createdAt && format(new Date(data?.data?.createdAt), 'MMM dd, yyyy')}</Typography>
