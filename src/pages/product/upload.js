...
import { uploadLookFile } from 'src/store/apps/service/category'
      ...
      <div {...getRootProps({ className: 'dropzone' })}>
        ...
        <Box sx={{ display: 'flex', flexDirection: ['column', 'column', 'column'], alignItems: 'center' }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', textAlign: ['center', 'center', 'center'] }}>
            <HeadingTypography variant="subtitle1">Drop files here or click to upload.</HeadingTypography>
